...
"[project]/app/admin/teams/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminTeamsPage() {
    ...
    const [memberRole, setMemberRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('MEMBER');
    const { data: teams, isLoading: loadingTeams } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'admin-teams'
        ],
        queryFn: {
            "AdminTeamsPage.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])('/api/v1/admin/teams', 'admin')
        }["AdminTeamsPage.useQuery"]
    });
    const { data: users } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "AdminTeamsPage.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])('/api/v1/admin/users', 'admin')
        }["AdminTeamsPage.useQuery"]
    });
    const { data: members, isLoading: loadingMembers } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'admin-team-members',
            selectedTeamId
        ],
        queryFn: {
            "AdminTeamsPage.useQuery": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiGet"])(`/api/v1/admin/teams/${selectedTeamId}/members`, 'admin')
        }["AdminTeamsPage.useQuery"],
        enabled: !!selectedTeamId
    });
    const createTeamMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AdminTeamsPage.useMutation[createTeamMutation]": ({ name, description })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiJson"])('/api/v1/admin/teams', 'POST', {
                    name,
                    description
                }, 'admin')
        }["AdminTeamsPage.useMutation[createTeamMutation]"],
        onSuccess: {
            "AdminTeamsPage.useMutation[createTeamMutation]": ()=>{
        ...
        onError: {
            "AdminTeamsPage.useMutation[createTeamMutation]": (error)=>setMessage(`Error: ${error.message}`)
        }["AdminTeamsPage.useMutation[createTeamMutation]"]
    });
    const deleteTeamMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AdminTeamsPage.useMutation[deleteTeamMutation]": (teamId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiDelete"])(`/api/v1/admin/teams/${teamId}`, 'admin')
        }["AdminTeamsPage.useMutation[deleteTeamMutation]"],
        onSuccess: {
            "AdminTeamsPage.useMutation[deleteTeamMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
        ...
        onError: {
            "AdminTeamsPage.useMutation[deleteTeamMutation]": (error)=>setMessage(`Error: ${error.message}`)
        }["AdminTeamsPage.useMutation[deleteTeamMutation]"]
    });
    const addMemberMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AdminTeamsPage.useMutation[addMemberMutation]": ({ teamId, userId, role })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiJson"])(`/api/v1/admin/teams/${teamId}/members`, 'POST', {
                    userId,
                    role
                }, 'admin')
        }["AdminTeamsPage.useMutation[addMemberMutation]"],
        onSuccess: {
            "AdminTeamsPage.useMutation[addMemberMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
        ...
        onError: {
            "AdminTeamsPage.useMutation[addMemberMutation]": (error)=>setMessage(`Error: ${error.message}`)
        }["AdminTeamsPage.useMutation[addMemberMutation]"]
    });
    const removeMemberMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "AdminTeamsPage.useMutation[removeMemberMutation]": (memberId)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiDelete"])(`/api/v1/admin/teams/members/${memberId}`, 'admin')
        }["AdminTeamsPage.useMutation[removeMemberMutation]"],
        onSuccess: {
            "AdminTeamsPage.useMutation[removeMemberMutation]": ()=>{
                queryClient.invalidateQueries({
                    queryKey: [
        ...
        onError: {
            "AdminTeamsPage.useMutation[removeMemberMutation]": (error)=>setMessage(`Error: ${error.message}`)
        }["AdminTeamsPage.useMutation[removeMemberMutation]"]
    });
    if (loadingTeams) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "card",
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "jsx-24b11ab50fc9c077" + " " + "stack",
                        children: selectedTeamId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "jsx-24b11ab50fc9c077" + " " + "card stack",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-24b11ab50fc9c077" + " " + "section-title",
                                ...
                                loadingMembers ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "jsx-24b11ab50fc9c077",
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                className: "jsx-24b11ab50fc9c077",
                                                children: [
                                                    members?.map((m)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            className: "jsx-24b11ab50fc9c077",
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    className: "jsx-24b11ab50fc9c077",
                                                    ...
                                                    (!members || members.length === 0) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        className: "jsx-24b11ab50fc9c077",
...
_s(AdminTeamsPage, "4gkg0rCkpz4MpRaXb3nGljEdWfc=", false, function() {
    return [
...
//# sourceMappingURL=_f61ba1d4._.js.map