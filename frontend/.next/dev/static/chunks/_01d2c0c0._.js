...
function RegisterPage() {
    ...
    async function onSubmit(event) {
        ...
        try {
            if (role === 'candidate') {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiJson"])('/api/v1/public/candidates/register', 'POST', {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiJson"])('/api/v1/public/clients/register', 'POST', {
                    name: form.get('name'),
                    email: form.get('email'),
                    password: form.get('password')
                }, 'public');
...
_s(RegisterPage, "I5b1vvsnS078BBSjUPGgJZToMKI=");
_c = RegisterPage;
var _c;
